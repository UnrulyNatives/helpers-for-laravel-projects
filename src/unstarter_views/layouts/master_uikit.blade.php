    ...
    <body class="tm-background">
        <div class="un_flex un_flex_ht">
            ...
            <article class="uk-article">
                ...
                @include('admin.navs._navs_main_admin')
        ...
        <link rel="stylesheet" type="text/css" href="{{URL::to('css/spaces.min.css')}}">
        {{-- CSS OVERRIDES FOR BASE THEME (UI-KIT), which name is DELAPAZ --}}
        <link rel="stylesheet" href="{{asset('css/adjustments_uikit.css')}}">
        <link rel="stylesheet" href="{{asset('css/adjustments_niepozwalam.css')}}">
